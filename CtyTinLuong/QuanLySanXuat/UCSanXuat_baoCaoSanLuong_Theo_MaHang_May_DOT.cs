...
{
    public partial class UCSanXuat_baoCaoSanLuong_Theo_MaHang_May_DOT : UserControl
    {
        private void HienThi()
        {
            ...
            dt2.Columns.Add("PhePham_May_DOT", typeof(double));
            ...
            {
                Decimal SoLuongNhap_May_DOT, SanLuongThuong_May_DOT, SanLuongTangCa_May_DOT, SanLuongTong_May_DOT, PhePham_May_DOT;
                ...
                PhePham_May_DOT = Convert.ToDecimal(dt3.Rows[i]["PhePham_May_DOT"].ToString());
                ...
                _ravi["PhePham_May_DOT"] = PhePham_May_DOT;
        ...
        public UCSanXuat_baoCaoSanLuong_Theo_MaHang_May_DOT()
        {
            InitializeComponent();
        }

        private void UCSanXuat_baoCaoSanLuong_Theo_MaHang_May_DOT_Load(object sender, EventArgs e)
        {
        ...
        {
            UCSanXuat_baoCaoSanLuong_Theo_MaHang_May_DOT_Load(sender, e);
        }
