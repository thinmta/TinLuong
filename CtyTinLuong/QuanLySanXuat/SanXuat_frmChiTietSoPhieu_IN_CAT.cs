...
{
    public partial class SanXuat_frmChiTietSoPhieu_IN_CAT : Form
    {
        #region May In
        ...
        public SanXuat_frmChiTietSoPhieu_IN_CAT()
        {
            InitializeComponent();
        }
        ...
        private void SanXuat_frmChiTietSoPhieu_IN_CAT_Load(object sender, EventArgs e)
        {
            bthemmoi_chietiet_mayIn = false;
            bthemmoi_chietiet_may_CAT = false;
