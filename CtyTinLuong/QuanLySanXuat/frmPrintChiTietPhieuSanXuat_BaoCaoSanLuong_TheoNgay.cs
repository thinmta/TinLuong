...
namespace CtyTinLuong
{
    public partial class frmPrintChiTietPhieuSanXuat_BaoCaoSanLuong_TheoNgay : Form
    {
        ...
        private void Printxxxxxxxx_frmBaoCaoSanLuongTheoNhomMay_IN_CAT_DOT()
        {
            ...
            {
                string strNgaySanXuat_INxxx;
                if (dt3.Rows[i]["NgaySanXuat_IN"].ToString() == "")
                    strNgaySanXuat_INxxx = "";
                else
                {
                    DateTime dteNgaySanXuat_IN = Convert.ToDateTime(dt3.Rows[i]["NgaySanXuat_IN"].ToString());
                    strNgaySanXuat_INxxx = dteNgaySanXuat_IN.ToString("dd/MM/yyyy");
                }
        ...
        private void Printxxxxxxxx_frmBaoCaoSanLuongTheoMaHang_IN_CAT_DOT()
        {
            Xtra_BaoCaoSanLuong_ToMay_IN xtr111 = new Xtra_BaoCaoSanLuong_ToMay_IN();
            DataTable dt3 = new DataTable();
            ...
            for (int i = 0; i < dt3.Rows.Count; i++)
            {
                ...
                double SoLuong_Ra_IN, PhePham_IN;
