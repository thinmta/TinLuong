...
{
    public partial class UCSanXuat_baoCaoSanLuong_Theo_MaHang : UserControl
    {
        private void HienThi()
        {
            ...
            dt2.Columns.Add("PhePham_May_IN", typeof(double));
            ...
            {
                Decimal SoLuongNhap_May_IN, SanLuongThuong_May_IN, SanLuongTangCa_May_IN, SanLuongTong_May_IN, PhePham_May_IN;
                ...
                PhePham_May_IN = Convert.ToDecimal(dt3.Rows[i]["PhePham_May_IN"].ToString());
                ...
                _ravi["PhePham_May_IN"] = PhePham_May_IN;
        ...
        public UCSanXuat_baoCaoSanLuong_Theo_MaHang()
        {
            InitializeComponent();
        }

        private void UCSanXuat_baoCaoSanLuong_Theo_MaHang_Load(object sender, EventArgs e)
        {
        ...
        {
            UCSanXuat_baoCaoSanLuong_Theo_MaHang_Load(sender, e);
        }
