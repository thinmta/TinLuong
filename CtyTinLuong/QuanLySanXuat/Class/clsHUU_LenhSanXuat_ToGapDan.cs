...
// Generated by LLBLGen v1.3.5996.26197 Final on: Wednesday, March 10, 2021, 1:10:03 PM
...
namespace CtyTinLuong
{
	...
	public partial class clsHUU_LenhSanXuat_ToGapDan : clsDBInteractionBase
	{
		#region Class Member Declarations
			private SqlBoolean		m_bTonTai, m_bTrangThai_NhapKho_ThanhPham, m_bNgungTheoDoi, m_bTrangThai_XuatKho_VatTuPhu, m_bTrangThai_XuatKho_VatTuChinh, m_bNhapKhoBTP, m_bGuiDuLieu;
			private SqlDateTime		m_daNgayThangSanXuat;
			private SqlDouble		m_fDonGia_ThanhPham, m_fSoLuong_ThanhPham, m_fPhePham, m_fThanhTien_ThanhPham;
			private SqlInt32		m_iID_VTHH_ThanhPham, m_iID_DinhMuc_Luong_SanLuong, m_iID_CaTruong, m_iID_CongNhan, m_iID_NguoiLap, m_iID_LenhSanXuat;
			private SqlString		m_sMaLenhSanXuat, m_sCaSanXuat, m_sGhiChu;
		#endregion
		...
		/// </summary>
		public clsHUU_LenhSanXuat_ToGapDan()
		{
			// Nothing for now.
		}
		...
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_LenhSanXuat_ToGapDan_Insert]";
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@bNhapKhoBTP", SqlDbType.Bit, 1, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_bNhapKhoBTP));
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_LenhSanXuat_ToGapDan_Insert' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("clsHUU_LenhSanXuat_ToGapDan::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_LenhSanXuat_ToGapDan_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_LenhSanXuat_ToGapDan_Update' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsHUU_LenhSanXuat_ToGapDan::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_LenhSanXuat_ToGapDan_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_LenhSanXuat_ToGapDan_Delete' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsHUU_LenhSanXuat_ToGapDan::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_LenhSanXuat_ToGapDan_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("HUU_LenhSanXuat_ToGapDan");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_LenhSanXuat_ToGapDan_SelectOne' reported the ErrorCode: " + m_iErrorCode);
				}
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_bTrangThai_XuatKho_VatTuChinh = (bool)dtToReturn.Rows[0]["TrangThai_XuatKho_VatTuChinh"];
					m_bTrangThai_XuatKho_VatTuPhu = (bool)dtToReturn.Rows[0]["TrangThai_XuatKho_VatTuPhu"];
					m_bTrangThai_NhapKho_ThanhPham = (bool)dtToReturn.Rows[0]["TrangThai_NhapKho_ThanhPham"];
					...
					m_bNhapKhoBTP = (bool)dtToReturn.Rows[0]["NhapKhoBTP"];
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsHUU_LenhSanXuat_ToGapDan::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_LenhSanXuat_ToGapDan_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("HUU_LenhSanXuat_ToGapDan");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_LenhSanXuat_ToGapDan_SelectAll' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsHUU_LenhSanXuat_ToGapDan::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		public SqlBoolean bNhapKhoBTP
		{
			get
			{
				return m_bNhapKhoBTP;
			}
			set
			{
				SqlBoolean bNhapKhoBTPTmp = (SqlBoolean)value;
				if(bNhapKhoBTPTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("bNhapKhoBTP", "bNhapKhoBTP can't be NULL");
				}
				m_bNhapKhoBTP = value;
			}
		}
