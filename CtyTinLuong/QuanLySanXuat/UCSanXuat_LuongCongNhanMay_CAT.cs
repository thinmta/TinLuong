...
{
    public partial class UCSanXuat_LuongCongNhanMay_CAT : UserControl
    {
        private void HienThi()
        {
            ...
            {
                Decimal SoLuongNhap_May_CAT, SanLuongThuong_May_CAT, SanLuongTangCa_May_CAT, SanLuongTong_May_CAT;
        ...
        public UCSanXuat_LuongCongNhanMay_CAT()
        {
            InitializeComponent();
        }

        private void UCSanXuat_LuongCongNhanMay_CAT_Load(object sender, EventArgs e)
        {
        ...
        {
            UCSanXuat_LuongCongNhanMay_CAT_Load(sender, e);
        }
