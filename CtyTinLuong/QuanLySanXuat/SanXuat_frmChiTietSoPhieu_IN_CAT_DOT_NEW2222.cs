...
namespace CtyTinLuong
{
    public partial class SanXuat_frmChiTietSoPhieu_IN_CAT_DOT_NEW2222 : Form
    {
        ...
        int iiiiID_SoPhieu;
        bool mbThemMoi_IN, mbThemMoi_CAT, mbThemMoi_DOT;
        ...
        {
            mbThemMoi_IN = mbThemMoi_CAT = mbThemMoi_DOT = true;
            Load_lockUP_Phieu();
            HienThi_Phieu();
            ...
            if (UC_SanXuat_PhieuSanXuat.mb_ThemMoi_SoPhieu == true)
            {
                try
                {
                    ...
                    gridDinhMucSLMay_DOT.EditValue = Convert.ToInt32(dtmdc.Rows[2]["ID_DinhMucLuong_TheoSanLuong"].ToString());
                }
                catch
                {
        ...
        {
            Luu_Va_Gui_Phieu();
            Luu_Va_GuiDuLieu_May_IN();
            Luu_Va_GuiDuLieu_May_CAT();
            ...
            // UPDATE tbPhieu
            MessageBox.Show("Đã lưu + và tạo lệnh sản xuất");
            this.Close();


            
            //if (cls.iBienTrangThai == 1)
            //{
            //    Luu_Va_GuiDuLieu_May_IN();
            //    TaoLenhSanXuat_IN();
            //}
            //else if (cls.iBienTrangThai == 2)
            //{
            //    Luu_Va_GuiDuLieu_May_IN();
            //    Luu_Va_GuiDuLieu_May_CAT();
            //    TaoLenhSanXuat_IN();
        ...
        private void Luu_ChiLuu_May_IN()
        {
            if (!KiemTraLuu_MayIn()) return;
            else if (mbThemMoi_IN == true)
            {
                clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();
            ...
            else if (mbThemMoi_IN == false)
            {
                clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();
                cls.iID_SoPhieu = UC_SanXuat_PhieuSanXuat.mID_iD_SoPhieu;
                DataTable dxxxx = cls.SelectAll_W_iID_SoPhieu();
                dxxxx.DefaultView.RowFilter = "bMay_IN = True";
                DataView dv1 = dxxxx.DefaultView;
                ...
                if (dt1.Rows.Count > 0)
                {
                    ...
                    {
                        int ID_ChiTietPhieu = Convert.ToInt32(dt1.Rows[0]["ID_ChiTietPhieu"].ToString());
                        int ID_SoPhieu = Convert.ToInt32(dt1.Rows[0]["ID_SoPhieu"].ToString());
                        int ID_May = Convert.ToInt32(gridMaMay_IN.EditValue.ToString());
                        int ID_CongNhan = Convert.ToInt32(gridMaCongNhan_May_IN.EditValue.ToString());
                        int ID_CaTruong = Convert.ToInt32(gridMaCaTruong_May_IN.EditValue.ToString());
                        DateTime NgaySanXuat = Convert.ToDateTime(dteNgaySanXuat_May_IN.EditValue.ToString());
        ...
        private void Luu_Va_GuiDuLieu_May_IN()
        {
            if (!KiemTraLuu_MayIn()) return;
            else
            {
                ...
                else // sua
                {
                    clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();
                    cls.iID_SoPhieu = UC_SanXuat_PhieuSanXuat.mID_iD_SoPhieu;
                    cls.sCaSanXuat = cbCaSanXuat_May_IN.Text.ToString();
                    cls.daNgaySanXuat = dteNgaySanXuat_May_IN.DateTime;
                    DataTable dt1 = cls.SelectAll_W_iID_SoPhieu_W_NgayThangSX_W_Ca_SX_Chon_May_IN();
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        double DonGia_Xuat = Convert.ToDouble(txtDonGiaXuat_May_IN.Text.ToString());
                        double PhePham = Convert.ToDouble(txtPhePham_May_IN.Text.ToString());
                        bool bbbbbTrangThaiXuatNhap = Convert.ToBoolean(dt1.Rows[0]["TrangThaiXuatNhap"].ToString());
                        bool bbbbbTrangThaiTaoLenhSanXuat = Convert.ToBoolean(dt1.Rows[0]["TrangThaiTaoLenhSanXuat"].ToString());
                        cls.iID_ChiTietPhieu = ID_ChiTietPhieu;
                        cls.iID_SoPhieu = ID_SoPhieu;
                        cls.iID_May = ID_May;
                        cls.iID_CongNhan = ID_CongNhan;
        ...
        private void TaoLenhSanXuat_IN()
        {
            clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();
            if (cbCaSanXuat_May_IN.Text.ToString() != "" & dteNgaySanXuat_May_IN.Text.ToString() != "")
            {
                ...
                if (dt1.Rows.Count > 0)
                {
                    int ID_ChiTietPhieu = Convert.ToInt32(dt1.Rows[0]["ID_ChiTietPhieu"].ToString());
                    cls.iID_ChiTietPhieu = ID_ChiTietPhieu;
                    DataTable dt121chitiet = cls.SelectOne();
                    if (cls.bTrangThaiTaoLenhSanXuat.Value == false)
                    {
                        //int ID_ChiTietPhieu = Convert.ToInt32(dt1.Rows[0]["ID_ChiTietPhieu"].ToString());
                        int ID_May = Convert.ToInt32(gridMaMay_IN.EditValue.ToString());
                        int ID_CongNhan = Convert.ToInt32(gridMaCongNhan_May_IN.EditValue.ToString());
                        ...
                        {
                            if (Convert.ToBoolean(dt1.Rows[0]["TrangThaiTaoLenhSanXuat"].ToString()) == false)
                            {
                                ...
                                clsLSX_chitiet.iID_SoPhieu = iiiiID_SoPhieu;
                        ...
                        // update trang thai tao lenh san xuat Phieu_ChiTietPhieu

                        cls.iID_ChiTietPhieu = Convert.ToInt32(dt1.Rows[0]["ID_ChiTietPhieu"].ToString());
        ...
        private void Load_lockUP_EDIT_may_IN()
        {
            ...
            dtMayIN.DefaultView.RowFilter = "TonTai=True and NgungTheoDoi=False and id_loai=1";
        ...
        private void Luu_ChiLuu_May_CAT()
        {
            if (!KiemTraLuu_May_CAT()) return;
            else if (mbThemMoi_CAT==true)
            {
                clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();                
            ...
            else if (mbThemMoi_CAT==false)
            {
                clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();
                cls.iID_SoPhieu = UC_SanXuat_PhieuSanXuat.mID_iD_SoPhieu;
                DataTable dxxxx = cls.SelectAll_W_iID_SoPhieu();
                dxxxx.DefaultView.RowFilter = "bMay_CAT = True";
                DataView dv2 = dxxxx.DefaultView;
                ...
                if (dt2.Rows.Count > 0)
                {
                    ...
                    {
                        int ID_ChiTietPhieu = Convert.ToInt32(dt2.Rows[0]["ID_ChiTietPhieu"].ToString());
                        int ID_SoPhieu = Convert.ToInt32(dt2.Rows[0]["ID_SoPhieu"].ToString());
                        int ID_May = Convert.ToInt32(gridMaMay_CAT.EditValue.ToString());
                        int ID_CongNhan = Convert.ToInt32(gridMaCongNhan_May_CAT.EditValue.ToString());
                        int ID_CaTruong = Convert.ToInt32(gridMaCaTruong_May_CAT.EditValue.ToString());
                        DateTime NgaySanXuat = Convert.ToDateTime(dteNgaySanXuat_May_CAT.EditValue.ToString());
            ...
            Luu_CongNhan_phuMayCat();
        }
        private void Luu_Va_GuiDuLieu_May_CAT()
        {
            if (!KiemTraLuu_May_CAT()) return;
            else
            {
                ...
                else // sua
                {
                    ...
                    clsPhieu_ChiTietPhieu_New cls = new CtyTinLuong.clsPhieu_ChiTietPhieu_New();
                    cls.iID_SoPhieu = UC_SanXuat_PhieuSanXuat.mID_iD_SoPhieu;
                    cls.sCaSanXuat = cbCaSanXuat_May_CAT.Text.ToString();
                    cls.daNgaySanXuat = dteNgaySanXuat_May_CAT.DateTime;
                    DataTable dt2 = cls.SelectAll_W_iID_SoPhieu_W_NgayThangSX_W_Ca_SX_Chon_May_CAT();
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        double DonGia_Xuat = Convert.ToDouble(txtDonGiaXuat_May_CAT.Text.ToString());
                        double PhePham = Convert.ToDouble(txtPhePham_May_CAT.Text.ToString());
                        bool bbbbbTrangThaiXuatNhap = Convert.ToBoolean(dt2.Rows[0]["TrangThaiXuatNhap"].ToString());
                        bool bbbbbTrangThaiTaoLenhSanXuat = Convert.ToBoolean(dt2.Rows[0]["TrangThaiTaoLenhSanXuat"].ToString());
                        cls.iID_ChiTietPhieu = ID_ChiTietPhieu;
                        cls.iID_SoPhieu = ID_SoPhieu;
                        cls.iID_May = ID_May;
                        cls.iID_CongNhan = ID_CongNhan;
        ...
        private void TaoLenhSanXuat_CAT()
        {
            clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();
            ...
            if (cbCaSanXuat_May_CAT.Text.ToString() != "" & dteNgaySanXuat_May_CAT.Text.ToString() != "")
            {
                ...
                if (dt2.Rows.Count > 0)
                {
                    ...
                    if (Convert.ToBoolean(dt2.Rows[0]["TrangThaiTaoLenhSanXuat"].ToString()) == false)
                    {
                        int ID_ChiTietPhieu = Convert.ToInt32(dt2.Rows[0]["ID_ChiTietPhieu"].ToString());
                        int ID_May = Convert.ToInt32(gridMaMay_CAT.EditValue.ToString());
                        int ID_CongNhan = Convert.ToInt32(gridMaCongNhan_May_CAT.EditValue.ToString());
                        ...
                        clschietphieunnewwwwwwww.iID_ChiTietPhieu = Convert.ToInt32(dt2.Rows[0]["ID_ChiTietPhieu"].ToString());
        ...
        private void Load_lockUP_EDIT_May_CAT()
        {
            ...
            clsT_MayMoc clsMayMoc = new clsT_MayMoc();
            DataTable dtMayIN = clsMayMoc.SelectAll();
            dtMayIN.DefaultView.RowFilter = "TonTai=True and NgungTheoDoi=False and id_loai=2";
            DataView dvMayIn = dtMayIN.DefaultView;
            DataTable newdtMayIn = dvMayIn.ToTable();
        ...
        private void Luu_ChiLuu_May_DOT()
        {
            if (!KiemTraLuu_May_DOT()) return;
            else if (mbThemMoi_DOT==true)
            {
                clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();
            ...
            else if (mbThemMoi_DOT==false)
            {
                clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();
                cls.iID_SoPhieu = UC_SanXuat_PhieuSanXuat.mID_iD_SoPhieu;
                DataTable dxxxx = cls.SelectAll_W_iID_SoPhieu();
                dxxxx.DefaultView.RowFilter = "bMay_DOT = True";
                DataView dv3 = dxxxx.DefaultView;
        ...
        private void Luu_Va_GuiDuLieu_May_DOT()
        {
            ...
            else
            {
                ...
                if (mbThemMoi_DOT==true) // them moi
                {
                    clsPhieu_ChiTietPhieu_New cls = new clsPhieu_ChiTietPhieu_New();
        ...
        private void gridHangHoaXuat_May_CAT_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                gridHangHoaVao_may_DOT.EditValue = Convert.ToInt32(gridHangHoaXuat_May_CAT.EditValue.ToString());
                DataTable dt = clsncc.SelectOne();
                if (dt.Rows.Count > 0)
                {
        ...
        {
           if(dteNgaySanXuat_May_DOT.DateTime!=null & cbCaSanXuat_May_DOT.Text.ToString()!="" & gridMaCongNhan_May_DOT.EditValue!=null & gridMaCaTruong_May_DOT.EditValue!=null)
            {
                mi_ID_Catruong= Convert.ToInt32(gridMaCaTruong_May_DOT.EditValue.ToString());
                MIiiiid_SoPhieu = UC_SanXuat_PhieuSanXuat.mID_iD_SoPhieu;
                mdaNgaySanXuatDot = dteNgaySanXuat_May_DOT.DateTime;
                msCaSXDot = cbCaSanXuat_May_DOT.Text.ToString();
                mi_ID_COngNhanh_MayDot_ToTruong = Convert.ToInt32(gridMaCongNhan_May_DOT.EditValue.ToString());
                frmBoSungCongNhanMay_Dot ff = new CtyTinLuong.frmBoSungCongNhanMay_Dot();
                ff.Show();
            }
        ...
        private void cbCaSanXuatPhieu_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (UC_SanXuat_PhieuSanXuat.mb_ThemMoi_SoPhieu == true)
            {
                ...
                cbCaSanXuat_May_DOT.Text = cbCaSanXuatPhieu.Text;
            }
        }
        ...
        private void dteNgayLap_EditValueChanged(object sender, EventArgs e)
        {
            if (UC_SanXuat_PhieuSanXuat.mb_ThemMoi_SoPhieu == true)
            {
                ...
                dteNgaySanXuat_May_DOT.EditValue = dteNgayLap.EditValue;
            }
        }
        ...
        private void txtSanLuongTong_May_IN_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                double Tongsltrongngayhienco = Convert.ToDouble(txtSanLuong_TrongNgay_IN.Text.ToString());
                double sanluongphieu = Convert.ToDouble(txtSanLuongTong_May_IN.Text.ToString());
                double tongsanluongmoi = Tongsltrongngayhienco + sanluongphieu;
                double sanluongmaxdinhmuc = 0;
                clsDinhMuc_DinhMuc_Luong_TheoSanLuong cls = new clsDinhMuc_DinhMuc_Luong_TheoSanLuong();
                cls.iID_DinhMuc_Luong_SanLuong = Convert.ToInt32(gridDinhMucSLMay_IN.EditValue.ToString());
                DataTable dt = cls.SelectOne();
                sanluongmaxdinhmuc = cls.fMaxSanLuongThuong.Value;
                if (tongsanluongmoi<= sanluongmaxdinhmuc)
                {
                ...
                {
                    if(Tongsltrongngayhienco>= sanluongmaxdinhmuc)
                    {
                    ...
                    {
                        txtSanLuong_tangca_May_IN.Text = (tongsanluongmoi - sanluongmaxdinhmuc).ToString();
                        txtSanLuong_Thuong_may_IN.Text = (sanluongmaxdinhmuc - Tongsltrongngayhienco).ToString();
                    }
        ...
        private void gridCNPhuMayCat_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                clsNhanSu_tbNhanSu clsncc = new clsNhanSu_tbNhanSu();
                clsncc.iID_NhanSu = Convert.ToInt32(gridCNPhuMayCat.EditValue.ToString());
                DataTable dt = clsncc.SelectOne();
                if (dt.Rows.Count > 0)
                {
                    txtTenCN_PhuMayCat.Text = dt.Rows[0]["TenNhanVien"].ToString();
        ...
        private void checkGiongNhau_CheckedChanged(object sender, EventArgs e)
        {
            if (checkGiongNhau.Checked == true)
            {
                try
                {
                    cbCaSanXuat_May_IN.Text = cbCaSanXuat_May_CAT.Text = cbCaSanXuat_May_DOT.Text = cbCaSanXuatPhieu.Text;
                    gridMaCaTruong_May_CAT.EditValue = gridMaCaTruong_May_DOT.EditValue = gridMaCaTruong_May_IN.EditValue = gridMaCaTruongPhieu.EditValue;
                    dteNgaySanXuat_May_IN.EditValue = dteNgaySanXuat_May_CAT.EditValue = dteNgaySanXuat_May_DOT.EditValue = dteNgayLap.EditValue;
        ...
        private void txtSanLuongTong_May_CAT_TextChanged(object sender, EventArgs e)
        {
            if (UC_SanXuat_PhieuSanXuat.mb_ThemMoi_SoPhieu == true)
            {
                txtSoLuongNhap_May_DOT.Text = txtSanLuongTong_May_CAT.Text;
            }

            try
            {
                double Tongsltrongngayhienco = Convert.ToDouble(txtSanLuong_TrongNgay_CAT.Text.ToString());
                ...
                else
                {
                    ...
                    {
                        txtSanLuong_tangca_May_CAT.Text = (tongsanluongmoi - sanluongmaxdinhmuc).ToString();
                        txtSanLuong_Thuong_may_CAT.Text = (sanluongmaxdinhmuc - Tongsltrongngayhienco).ToString();
                    }
        ...
        private void btCopY_Click(object sender, EventArgs e)
        {
            ...
            UC_SanXuat_PhieuSanXuat.mbCopy_Phieu = false;
            UC_SanXuat_PhieuSanXuat.mb_Sua_SoPhieu = false;
            txtMaPhieu.ResetText();
