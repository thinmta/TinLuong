...
{
    public partial class UCSanXuat_baoCaoSanLuong_May_CAT : UserControl
    {
        ...
        public UCSanXuat_baoCaoSanLuong_May_CAT()
        {
            InitializeComponent();
        }

        private void UCSanXuat_baoCaoSanLuong_May_CAT_Load(object sender, EventArgs e)
        {
        ...
        {
            UCSanXuat_baoCaoSanLuong_May_CAT_Load( sender,  e);
        }
