...
{
    public partial class Thin_SanXuat_APP_May_IN : Form
    {
        bool mbthemmoi;
        ...
        private void HienThi_MacDinh()
        {
            if (dteNgayLap.EditValue != null & gridMaPhieu.EditValue != null)
            {
                ...
                dtxx.DefaultView.RowFilter = " bMay_IN=True";
        ...
        public Thin_SanXuat_APP_May_IN()
        {
            InitializeComponent();
        }
        ...
        private void Thin_SanXuat_APP_May_IN_Load(object sender, EventArgs e)
        {
            Load_lockUP_EDIT();
        ...
        {
            this.Close();
            Thin_SanXuat_APP_May_CAT ff = new CtyTinLuong.Thin_SanXuat_APP_May_CAT();
            ff.Show();
        }
    }
}
