...
{
    public partial class Thin_SanXuat_APP_May_CAT : Form
    {
        bool mbthemmoi;
        ...
        private void HienThi_MacDinh()
        {
            if (dteNgayLap.EditValue != null & gridMaPhieu.EditValue != null)
            {
                ...
                dtxx.DefaultView.RowFilter = " bMay_CAT=True";
        ...
        public Thin_SanXuat_APP_May_CAT()
        {
            InitializeComponent();
        }

        private void Thin_SanXuat_APP_May_CAT_Load(object sender, EventArgs e)
        {
            Load_lockUP_EDIT();
        ...
        private void btDenMayDot_Click(object sender, EventArgs e)
        {
            this.Close();
            Thin_SanXuat_APP_May_DOT ff = new CtyTinLuong.Thin_SanXuat_APP_May_DOT();
            ff.Show();
        }
    }
}
