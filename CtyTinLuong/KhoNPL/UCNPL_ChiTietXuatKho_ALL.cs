...
{
    public partial class UCNPL_ChiTietXuatKho_ALL : UserControl
    {
        ...
        private void HienThi()
        {
            if (dteTuNgay.EditValue != null & dteNgay.EditValue != null)
            {
                ...
                clsKhoNPL_tbChiTietXuatKho cls = new CtyTinLuong.clsKhoNPL_tbChiTietXuatKho();
        ...
        public UCNPL_ChiTietXuatKho_ALL()
        {
            InitializeComponent();
        }

        private void UCNPL_ChiTietXuatKho_ALL_Load(object sender, EventArgs e)
        {
        ...
        {
            UCNPL_ChiTietXuatKho_ALL_Load( sender,  e);
        }
