...
// Generated by LLBLGen v1.3.5996.26197 Final on: Friday, April 9, 2021, 3:52:40 PM
...
namespace CtyTinLuong
{
	...
	public partial class clsKhoNPL_tbXuatKho : clsDBInteractionBase
	{
		#region Class Member Declarations
			private SqlBoolean		m_bTonTai, m_bCheckDongBao_DongKien, m_bDaXuatKho, m_bNgungTheoDoi;
		...
		///		 <LI>sThamChieu. May be SqlString.Null</LI>
		///		 <LI>bDaXuatKho. May be SqlBoolean.Null</LI>
		///		 <LI>bCheckDongBao_DongKien. May be SqlBoolean.Null</LI>
		/// </UL>
		...
		public override bool Insert()
		{
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@bCheckDongBao_DongKien", SqlDbType.Bit, 1, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_bCheckDongBao_DongKien));
		...
		public override DataTable SelectOne()
		{
			...
			try
			{
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_sThamChieu = dtToReturn.Rows[0]["ThamChieu"] == System.DBNull.Value ? SqlString.Null : (string)dtToReturn.Rows[0]["ThamChieu"];
					m_bDaXuatKho = dtToReturn.Rows[0]["DaXuatKho"] == System.DBNull.Value ? SqlBoolean.Null : (bool)dtToReturn.Rows[0]["DaXuatKho"];
					m_bCheckDongBao_DongKien = dtToReturn.Rows[0]["CheckDongBao_DongKien"] == System.DBNull.Value ? SqlBoolean.Null : (bool)dtToReturn.Rows[0]["CheckDongBao_DongKien"];
				}
				return dtToReturn;
			}
			catch(Exception ex)
		...
		public SqlBoolean bCheckDongBao_DongKien
		{
			get
			{
				return m_bCheckDongBao_DongKien;
			}
			set
			{
				SqlBoolean bCheckDongBao_DongKienTmp = (SqlBoolean)value;
				if(bCheckDongBao_DongKienTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("bCheckDongBao_DongKien", "bCheckDongBao_DongKien can't be NULL");
				}
				m_bCheckDongBao_DongKien = value;
			}
		}
		#endregion
	}
