...
// Generated by LLBLGen v1.3.5996.26197 Final on: Saturday, May 22, 2021, 3:46:37 PM
...
namespace CtyTinLuong
{
	...
	public partial class clsKhoNPL_tbNhapKho : clsDBInteractionBase
	{
		...
		///		 <LI>bTonTai</LI>
		///		 <LI>bNgungTheoDoi</LI>
		///		 <LI>iID_NguoiNhapKho</LI>
		///		 <LI>sThamChieu. May be SqlString.Null</LI>
		///		 <LI>bDaNhapKho. May be SqlBoolean.Null</LI>
		///		 <LI>bBool_TonDauKy. May be SqlBoolean.Null</LI>
		///		 <LI>bCheck_NhapKho_Khac. May be SqlBoolean.Null</LI>
		/// </UL>
		...
		public override DataTable SelectOne()
		{
			...
			try
			{
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_bCheck_NhapKho_Khac = dtToReturn.Rows[0]["Check_NhapKho_Khac"] == System.DBNull.Value ? SqlBoolean.Null : (bool)dtToReturn.Rows[0]["Check_NhapKho_Khac"];
				}
				return dtToReturn;
			}
			catch(Exception ex)
