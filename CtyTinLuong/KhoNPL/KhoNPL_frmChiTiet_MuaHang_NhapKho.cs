...
namespace CtyTinLuong
{
    ...
    {       
        ...
        private void Print_CUUUU()
        {

            //if (!KiemTraLuu()) return;
            //else
            //{
            //    mbPrint_Chitiet_NhapKho_TuMuaHang = true;

            //    mdt_ChiTietNhapKho = new DataTable();
            ...
            //    dttttt2.DefaultView.RowFilter = "HienThi=" + shienthi + "";
            //    DataView dvmoi = dttttt2.DefaultView;
            //    DataTable dt3 = dvmoi.ToTable();
            //    //double deTOngtien;
            //    object xxxx = dt3.Compute("sum(ThanhTien)", "HienThi=" + shienthi + "");
            //    mdeTongTienHang_KhongVAT = Convert.ToDouble(xxxx);

            //    for (int i = 0; i < dt3.Rows.Count; i++)
            //    {
            //        DataRow _ravi = mdt_ChiTietNhapKho.NewRow();
            ...
            //        mdt_ChiTietNhapKho.Rows.Add(_ravi);
            //    }


            //    int ID_MuaHang = Convert.ToInt32(dt3.Rows[0]["ID_MuaHang"].ToString());
            //    clsMH_tbMuaHang clsxx = new clsMH_tbMuaHang();
            //    clsxx.iID_MuaHang = ID_MuaHang;
            //    DataTable dtmahang = clsxx.SelectOne();
            //    int miID_NguoiMua = clsxx.iID_MuaHang.Value;
            //    mdeTienVAT = clsxx.fTienVAT.Value;
            //    mdeTongTienHang_CoVAT = mdeTongTienHang_KhongVAT + mdeTienVAT;
            //    clsNganHang_ChiTietBienDongTaiKhoanKeToan clstaikhoan = new clsNganHang_ChiTietBienDongTaiKhoanKeToan();
            //    clstaikhoan.iID_ChungTu = clsxx.iID_MuaHang;
            //    clstaikhoan.sSoChungTu = clsxx.sSoChungTu;
            //    clstaikhoan.daNgayThang = clsxx.daNgayChungTu;
            //    DataTable dttaikhoan = clstaikhoan.Select_W_iID_ChungTu_sSoChungTu_daNgayThang();
            //    for (int i = 0; i < dttaikhoan.Rows.Count; i++)
            //    {
            //        clsNganHang_TaiKhoanKeToanCon clscon = new clsNganHang_TaiKhoanKeToanCon();
            //        if (Convert.ToBoolean(dttaikhoan.Rows[i]["BoolTK_No"].ToString()) == true)
            //        {
            //            int iIDID_TaiKhoanKeToanCon = Convert.ToInt32(dttaikhoan.Rows[i]["ID_TaiKhoanKeToanCon"].ToString());
            //            clscon.iID_TaiKhoanKeToanCon = iIDID_TaiKhoanKeToanCon;
            //            DataTable dtcon = clscon.SelectOne();
            //            msTKNo = clscon.sSoTaiKhoanCon.Value;
            //            mdeTienNo = Convert.ToDouble(dttaikhoan.Rows[i]["No"].ToString());
            //        }
            //        if (Convert.ToBoolean(dttaikhoan.Rows[i]["BoolTK_Co"].ToString()) == true)
            //        {
            //            int iIDID_TaiKhoanKeToanCon = Convert.ToInt32(dttaikhoan.Rows[i]["ID_TaiKhoanKeToanCon"].ToString());
            //            clscon.iID_TaiKhoanKeToanCon = iIDID_TaiKhoanKeToanCon;
            //            DataTable dtcon = clscon.SelectOne();
            //            msTKCo = clscon.sSoTaiKhoanCon.Value;
            //            mdeTienCo = Convert.ToDouble(dttaikhoan.Rows[i]["Co"].ToString());
            //        }
            //        if (Convert.ToBoolean(dttaikhoan.Rows[i]["BoolTKVAT"].ToString()) == true)
            //        {
            //            int iIDID_TaiKhoanKeToanCon = Convert.ToInt32(dttaikhoan.Rows[i]["ID_TaiKhoanKeToanCon"].ToString());
            //            clscon.iID_TaiKhoanKeToanCon = iIDID_TaiKhoanKeToanCon;
            //            DataTable dtcon = clscon.SelectOne();
            //            msTKVAT = clscon.sSoTaiKhoanCon.Value;

            //        }
            //        else if (Convert.ToBoolean(dttaikhoan.Rows[i]["BoolTKVAT"].ToString()) == false) msTKVAT = "";
            //        //
            //    }
            //    clsNhanSu_tbNhanSu clsnhansu = new clsNhanSu_tbNhanSu();
            //    clsnhansu.iID_NhanSu = miID_NguoiMua;
            //    DataTable dtxx = clsnhansu.SelectOne();
            //    msNguoiMuaHang = clsnhansu.sTenNhanVien.Value;
            ...
            //    msSoChungTu_MuaHang = clsxx.sSoChungTu.Value;
            //    msSoHoaDon_MuaHang = clsxx.sSoHoaDon.Value;

                //frmkhoNPL_nguoiKy ff = new frmkhoNPL_nguoiKy();
                //ff.Show();
            //}
