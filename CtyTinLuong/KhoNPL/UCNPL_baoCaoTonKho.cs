...
{
    public partial class UCNPL_baoCaoTonKho : UserControl
    {
        public DataTable tinhtoanNXT_NhapXuat_TrongKy()
        {

            clsKhoNPL_tbChiTietNhapKho clsnpl = new CtyTinLuong.clsKhoNPL_tbChiTietNhapKho();
        ...
        {
            clsKhoNPL_tbChiTiet_TonDauKy cls = new clsKhoNPL_tbChiTiet_TonDauKy();
        ...
        private void HienThi()
        {
            ...
            for (int i = 0; i < dtnpl.Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    DataTable dt = cls.SelectOne_W_ID_VTHH();
        ...
        public UCNPL_baoCaoTonKho()
        {
            InitializeComponent();
        }

        private void UCNPL_baoCaoTonKho_Load(object sender, EventArgs e)        {
