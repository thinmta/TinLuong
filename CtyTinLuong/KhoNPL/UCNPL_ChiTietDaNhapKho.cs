...
{
    public partial class UCNPL_ChiTietDaNhapKho : UserControl
    {
        ...
        private void HienThi()
        {
            if (dteTuNgay.EditValue != null & dteNgay.EditValue != null)
            {
                ...
                dt.DefaultView.RowFilter = " DaNhapKho = True and NgayChungTu<='" + denngay + "'";
        ...
        private void HienThi_ALL()
        {
            ...
            clsKhoNPL_tbChiTietNhapKho cls = new CtyTinLuong.clsKhoNPL_tbChiTietNhapKho();
            DataTable dt = cls.SelectAll_HienThi_ALL_ChiTietNhapKho();
            dt.DefaultView.RowFilter = " DaNhapKho = True";
        ...
        public UCNPL_ChiTietDaNhapKho()
        {
            InitializeComponent();
        }

        private void UCNPL_ChiTietDaNhapKho_Load(object sender, EventArgs e)
        {
        ...
        {
            UCNPL_ChiTietDaNhapKho_Load( sender,  e);
        }
