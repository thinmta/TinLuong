...
{
    public partial class UCBanThanhPham_NhapKhoTheoLenhSanXuat : UserControl
    {
        ...
        private void HienThi()
        {
            ...
            DataTable dt = cls.SelectAll_NhapKho_KhoBanThanhPham_Tat_CA();
        ...
        public UCBanThanhPham_NhapKhoTheoLenhSanXuat()
        {
            InitializeComponent();
        }

        private void UCBanThanhPham_NhapKhoTheoLenhSanXuat_Load(object sender, EventArgs e)
        {
        ...
        {
            UCBanThanhPham_NhapKhoTheoLenhSanXuat_Load( sender,  e);
        }
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                if (gridView1.GetFocusedRowCellValue(clID_LenhSanXuat).ToString() != "")
                {
                    ...
                    if (iiD_LoaiMay == 1)
                    {
                        KhoBTP_ChiTietNhapKhoTheoLenhSanXuat_May_CAT ff = new KhoBTP_ChiTietNhapKhoTheoLenhSanXuat_May_CAT();
                        ff.Show();
                    }
                    ...
                    {
                        KhoBTP_ChiTietNhapKhoTheoLenhSanXuat_May_DOT ff = new KhoBTP_ChiTietNhapKhoTheoLenhSanXuat_May_DOT();
                        ff.Show();
                    }
                }
            }
