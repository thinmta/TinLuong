...
{
    public partial class KhoBTP_ChiTietNhapKhoTheoLenhSanXuat_May_CAT : Form
    {
        ...
        private void HienThi_SUa_LenhSanXuat()
        {
            ...
            for (int i = 0; i < dtxxxx.Rows.Count; i++)
            {
                ...
                _ravi["ThanhTien"] = tonganluong * dongia;
                _ravi["HienThi"] = "1";
        ...
        public KhoBTP_ChiTietNhapKhoTheoLenhSanXuat_May_CAT()
        {
            InitializeComponent();
        }
        ...
        private void KhoBTP_ChiTietNhapKhoTheoLenhSanXuat_May_CAT_Load(object sender, EventArgs e)
        {
