...
{
    public partial class UCBanThanhPham_ChiTietDaXuatKho_ALL : UserControl
    {
        ...
        private void HienThi()
        {
            if (dteTuNgay.EditValue != null & dteNgay.EditValue != null)
            {
                ...
                clsKhoBTP_ChiTietXuatKho cls = new CtyTinLuong.clsKhoBTP_ChiTietXuatKho();
                DataTable dt = cls.SelectAll_HienThi_ALL_ChiTietXuatKho();
        ...
        public UCBanThanhPham_ChiTietDaXuatKho_ALL()
        {
            InitializeComponent();
        }

        private void UCBanThanhPham_ChiTietDaXuatKho_ALL_Load(object sender, EventArgs e)
        {
        ...
        {
            UCBanThanhPham_ChiTietDaXuatKho_ALL_Load( sender,  e);
        }
