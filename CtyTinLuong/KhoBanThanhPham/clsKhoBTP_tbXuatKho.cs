...
namespace CtyTinLuong
{
	...
	public partial class clsKhoBTP_tbXuatKho : clsDBInteractionBase
	{
		...
		///		 <LI>sThamChieu</LI>
		///		 <LI>bDaXuatKho</LI>
		///		 <LI>bCheck_XuatKho_Khac. May be SqlBoolean.Null</LI>
		/// </UL>
		...
		public override DataTable SelectOne()
		{
			...
			try
			{
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_bCheck_XuatKho_Khac = dtToReturn.Rows[0]["Check_XuatKho_Khac"] == System.DBNull.Value ? SqlBoolean.Null : (bool)dtToReturn.Rows[0]["Check_XuatKho_Khac"];
				}
				return dtToReturn;
			}
			catch(Exception ex)
