...
{
    public partial class KhoBTP_ChiTiet_XuatKho_TheoLenhSanXuat_May_CAT : Form
    {
        ...
        private void Luu_XuatKho_BTP()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < dtmoi.Rows.Count; i++)
                {
                    ...
                    clsnhapkho.iID_VTHH = Convert.ToInt32(dtmoi.Rows[i]["ID_VTHH_Vao"].ToString());
                    ...
                    int iiiID_VTHH = Convert.ToInt32(dtmoi.Rows[i]["ID_VTHH_Vao"].ToString());
        ...
        private void HienThi_SUa_LenhSanXuat()
        {
            ...
            for (int i = 0; i < dtxxxx.Rows.Count; i++)
            {
                ...
                int iiDI_Vthh_vao = Convert.ToInt32(dtxxxx.Rows[i]["ID_VTHHVao"].ToString());
        ...
        public KhoBTP_ChiTiet_XuatKho_TheoLenhSanXuat_May_CAT()
        {
            InitializeComponent();
        }
        ...
        private void KhoBTP_ChiTiet_XuatKho_TheoLenhSanXuat_May_CAT_Load(object sender, EventArgs e)
        {
