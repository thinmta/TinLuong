...
{
    public partial class UCBanThanhPham_TongHopTonKho : UserControl
    {
        public DataTable tinhtoanNXT_NhapXuat_TrongKy()
        {

            clsKhoBTP_tbChiTietNhapKho clsnpl = new CtyTinLuong.clsKhoBTP_tbChiTietNhapKho();
        ...
        {
            clsKhoBTP_tbChiTiet_tonDauKy cls = new clsKhoBTP_tbChiTiet_tonDauKy();
        ...
        public UCBanThanhPham_TongHopTonKho()
        {
            InitializeComponent();
        }

        private void UCBanThanhPham_TongHopTonKho_Load(object sender, EventArgs e)
        {
            HienThi();
        }
