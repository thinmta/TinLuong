...
{
    public partial class UCCaiDatBanDau_Kho_ThanhPham : UserControl
    {
        private void HienThi()
        {
            clsKhoThanhPham_tbChiTietTonDauKy cls2 = new clsKhoThanhPham_tbChiTietTonDauKy();
        ...
        {
            clsKhoThanhPham_tbChiTietTonDauKy cls1 = new clsKhoThanhPham_tbChiTietTonDauKy();
        ...
        public UCCaiDatBanDau_Kho_ThanhPham()
        {
            InitializeComponent();
        }

        private void UCCaiDatBanDau_Kho_ThanhPham_Load(object sender, EventArgs e)
        {
            btLuu.Visible = false;
            Load_LockUp();
            HienThi();
        ...
        {
            UCCaiDatBanDau_Kho_ThanhPham_Load( sender,  e);
        }
        ...
        private void btXoa2_Click(object sender, EventArgs e)
        {
            ...
            {
                clsKhoThanhPham_tbChiTietTonDauKy cls = new CtyTinLuong.clsKhoThanhPham_tbChiTietTonDauKy();
