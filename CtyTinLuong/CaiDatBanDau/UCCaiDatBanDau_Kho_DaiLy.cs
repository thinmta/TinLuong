...
{
    public partial class UCCaiDatBanDau_Kho_DaiLy : UserControl
    {
        private void HienThi()
        {
            clsDaiLy_tbChiTiet_TonDauKy cls2 = new clsDaiLy_tbChiTiet_TonDauKy();
        ...
        {
            clsDaiLy_tbChiTiet_TonDauKy cls1 = new clsDaiLy_tbChiTiet_TonDauKy();
        ...
        public UCCaiDatBanDau_Kho_DaiLy()
        {
            InitializeComponent();
        }

        private void UCCaiDatBanDau_Kho_DaiLy_Load(object sender, EventArgs e)
        {
            btLuu.Visible = false;
            Load_LockUp();
            HienThi();
        ...
        {
            UCCaiDatBanDau_Kho_DaiLy_Load( sender,  e);
        }
        ...
        private void btXoa2_Click(object sender, EventArgs e)
        {
            ...
            {
                clsDaiLy_tbChiTiet_TonDauKy cls = new CtyTinLuong.clsDaiLy_tbChiTiet_TonDauKy();
