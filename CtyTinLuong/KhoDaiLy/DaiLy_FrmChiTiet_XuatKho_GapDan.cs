...
namespace CtyTinLuong
{
    public partial class DaiLy_FrmChiTiet_XuatKho_GapDan : Form
    {
        ...
        {
            Load_LockUp();
            if (UCDaiLy_XuatKho_GapDan.mbThemMoi_XuatKho_GapDan == true)
        ...
        private void gridDinhMucGapDan_EditValueChanged(object sender, EventArgs e)
        {
            ...
            clsGapDan_tbNhapKho cls2 = new clsGapDan_tbNhapKho();
            cls2.iID_DinhMuc_ToGapDan = Convert.ToInt32(gridDinhMucGapDan.EditValue.ToString());
            DataTable dt2 = cls2.SelectALL_W_ID_DinhMuc_ToGapDan();
            dt2.DefaultView.RowFilter = "TonTai=True and NgungTheoDoi = False and DaNhapKho=True";
            DataView dv2 = dt2.DefaultView;
            DataTable dt223 = dv2.ToTable();
            gridThamChieu.Properties.DataSource = dt223;
            gridThamChieu.Properties.ValueMember = "ID_NhapKho";
            gridThamChieu.Properties.DisplayMember = "SoChungTu";
        ...
        private void gridThamChieu_EditValueChanged(object sender, EventArgs e)
        {
            clsGapDan_tbNhapKho cls = new clsGapDan_tbNhapKho();
            cls.iID_NhapKho = Convert.ToInt32(gridThamChieu.EditValue.ToString());
            DataTable dt = cls.SelectOne();
            txtSoLuongXuat.Text = dt.Rows[0]["SoLuongThanhPham_QuyDoi"].ToString();
        }

        private void txtDonGiaThanhPhamQuyDoi_Layout(object sender, LayoutEventArgs e)
        {
