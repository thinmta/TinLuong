...
namespace CtyTinLuong
{
	...
	public partial class clsGapDan_ChiTiet_XuatKho : clsDBInteractionBase
	{
		#region Class Member Declarations
			private SqlBoolean		m_bNgungTheoDoi, m_bCheck_VatTu_Phu, m_bDaXuatKho, m_bCheck_VatTu_Chinh, m_bCheck_ThanhPham, m_bTonTai;
			private SqlDouble		m_fSoLuongXuat, m_fDonGia;
			private SqlInt32		m_iID_XuatKho, m_iID_VTHH, m_iID_ChiTietXuatKho;
