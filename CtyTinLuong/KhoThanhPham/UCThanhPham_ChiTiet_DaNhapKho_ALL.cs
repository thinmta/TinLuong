...
{
    public partial class UCThanhPham_ChiTiet_DaNhapKho_ALL : UserControl
    {
        ...
        public UCThanhPham_ChiTiet_DaNhapKho_ALL()
        {
            InitializeComponent();
        }

        private void UCThanhPham_ChiTiet_DaNhapKho_ALL_Load(object sender, EventArgs e)
        {
        ...
        {
            UCThanhPham_ChiTiet_DaNhapKho_ALL_Load( sender,  e);
        }
